...
![alt text](https://ucb-courses.s3.us-west-1.amazonaws.com/CS198-99/bloom/1.2-Advanced-CSS-and-Intro-JavaScript/Module_2-Intro-to-JavaScript/Assignment/assets/split_terminal.png "Split Terminal")

Inside of your second terminal type `npm start` 
![alt text](https://ucb-courses.s3.us-west-1.amazonaws.com/CS198-99/bloom/1.2-Advanced-CSS-and-Intro-JavaScript/Module_2-Intro-to-JavaScript/Assignment/assets/npm_start.png "type npm start")

You will be running your tests in one terminal and debugging in the other. As you work on your code you should make use of `console.log` to check your progress and debug.
![alt text](https://ucb-courses.s3.us-west-1.amazonaws.com/CS198-99/bloom/1.2-Advanced-CSS-and-Intro-JavaScript/Module_2-Intro-to-JavaScript/Assignment/assets/tests_debug_terminal_final.png "your terminal should look like this")
